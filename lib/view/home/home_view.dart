                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ExercisesRow(
                              ...
                              time: "30 min",
                              isActive: true,
                              onPressed: () => Navigator.push(context,MaterialPageRoute(builder: (context) => const ExerciseRoutine()))),
                          ExercisesRow(
                              number: "2",
                              title: "Exercises 2",
                              time: "30 min",
                              onPressed: () => Navigator.push(context,MaterialPageRoute(builder: (context) => const ExerciseRoutine2()))),
                          ExercisesRow(
                              number: "3",
                              title: "Finished",
                              time: "30 min",
                              isLast: true,
                              onPressed: () => Navigator.push(context,MaterialPageRoute(builder: (context) => const ExerciseRoutine3()))),
                          const Spacer(),
                          SizedBox(
                            width: 150,
                            height: 40,
